...
CREATE TABLE `artis` (
  ...
  `artis_name` varchar(45) NOT NULL,
  `desciption` varchar(1024) DEFAULT NULL,
  `url` varchar(100) DEFAULT NULL,
  PRIMARY KEY (`artis_id`),
  UNIQUE KEY `artis_name_UNIQUE` (`artis_name`)
...
-- Dump completed on 2024-10-03 21:13:59
